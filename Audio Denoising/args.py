...
parser.add_argument('--noise_dir', default='C:/Users/harsh/Audio Denoising/DATA/Train/noise', type=str)

parser.add_argument('--voice_dir', default='C:/Users/harsh/Audio Denoising/DATA/Train/clean_voice', type=str)
#folders where to save spectrograms, time series and sounds for training / QC
parser.add_argument('--path_save_spectrogram', default='C:/Users/harsh/Audio Denoising/DATA/Train/spectrogram/', type=str)

parser.add_argument('--path_save_time_serie', default='C:/Users/harsh/Audio Denoising/DATA/Train/time_serie/', type=str)

parser.add_argument('--path_save_sound', default='C:/Users/harsh/Audio Denoising/DATA/Train/sound/', type=str)
